package com.projects.distributed_lovable.api_gateway.filter;
...
import com.projects.distributed_lovable.api_gateway.config.SecurityProperties;
import com.projects.distributed_lovable.api_gateway.error.ApiError;
import com.projects.distributed_lovable.api_gateway.service.JwtGatewayService;
...
public class GatewayJwtAuthFilter implements GlobalFilter, Ordered {
    ...
    private Mono<Void> sendErrorResponse(ServerWebExchange exchange, HttpStatus status, String message) {
        ...
        try {
            ...
            log.error("Error serialization gateway error response", e);
