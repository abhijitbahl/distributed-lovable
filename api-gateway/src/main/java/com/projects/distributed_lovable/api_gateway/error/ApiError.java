package com.projects.distributed_lovable.api_gateway.error;
...
public record ApiError(
        ...
        String message,
        Instant timestamp,
        @JsonInclude(JsonInclude.Include.NON_NULL) List<ApiFieldError> errors // only for validation errors
) {
