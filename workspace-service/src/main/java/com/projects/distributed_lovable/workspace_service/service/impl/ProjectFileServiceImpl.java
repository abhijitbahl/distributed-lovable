...
import com.projects.distributed_lovable.workspace_service.mapper.ProjectFileMapper;
...
public class ProjectFileServiceImpl implements ProjectFileService {
    ...
    public FileTreeDto getFileTree(Long projectId) {
        ...
        return new FileTreeDto(projectFileMapper.toFileNodeList(projectFileList));
    }
    ...
    public String getFileContent(Long projectId, String path) {
        ...
        try (
            ...
            log.error("Failed to get file content for project {}: path={}", projectId, path, e);
    ...
    public void saveFile(Long projectId, String path, String content) {
        ...
        log.info("Saving file for project {}: path={}, content={}", project.getName(), path, content);
